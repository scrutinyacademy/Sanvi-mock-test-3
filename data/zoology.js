window.ZOOLOGY_QUESTIONS = [
  ...
  },
  {
    ...
    "topic": "External Morphology",
    "difficulty": "Easy",
    "question": "Frogs normally absorb water primarily through:",
    "options": [
    ...
    "answer": 3,
    "explanation": "Frogs generally do not drink water; water is absorbed across their permeable skin."
  },
  {
    "id": "Z05",
    "section": "Zoology",
    "topic": "Protective Colouration",
    "difficulty": "Easy",
  ...
  },
  {
    ...
    "topic": "Sense Organs",
    "difficulty": "Easy",
    "question": "The transparent membrane that protects a frog's eye in water is the:",
    "options": [
      "tympanum",
      "cornea",
      "iris",
    ...
    "answer": 3,
    "explanation": "The nictitating membrane can cover the eye and protect it, especially while swimming."
  },
  {
    "id": "Z08",
    "section": "Zoology",
  ...
  },
  {
    ...
    "difficulty": "Easy",
    "question": "The common chamber into which the alimentary, urinary and reproductive tracts open is the:",
    "options": [
      "pharynx",
      "duodenum",
      "rectum",
    ...
    "answer": 3,
    "explanation": "The cloaca receives material from the digestive, excretory and reproductive systems and opens outside through the cloacal aperture."
  },
  {
    "id": "Z13",
    "section": "Zoology",
    "topic": "Buccal Cavity",
    "difficulty": "Easy",
    "question": "Teeth in a frog are primarily used to:",
    "options": [
  ...
  },
  {
    "id": "Z16",
    "section": "Zoology",
    "topic": "Digestive Glands",
    "difficulty": "Easy",
    "question": "The bile-producing organ in a frog is the:",
    "options": [
      "pancreas",
      "stomach",
      "liver",
  ...
  },
  {
    ...
    "topic": "Digestion",
    "difficulty": "Easy",
    "question": "Protein digestion in a frog begins mainly in the:",
    "options": [
      "mouth",
      "cloaca",
      "large intestine",
    ...
    "answer": 3,
    "explanation": "Gastric juice containing hydrochloric acid and pepsin begins protein digestion in the stomach."
  },
  {
    "id": "Z19",
    "section": "Zoology",
  ...
  },
  {
    ...
    "topic": "Heart",
    "difficulty": "Moderate",
    "question": "The chamber from which the truncus arteriosus arises is the:",
    "options": [
      "ventricle",
      "left atrium",
      "right atrium",
    ...
    "answer": 0,
    "explanation": "The single ventricle pumps blood into the anterior truncus arteriosus for distribution."
  },
  {
    "id": "Z27",
    "section": "Zoology",
  ...
  },
  {
    ...
    "difficulty": "Easy",
    "question": "The chief nitrogenous waste excreted by an adult frog is:",
    "options": [
      "ammonia",
      "uric acid",
      "urea",
    ...
    "answer": 2,
    "explanation": "Adult frogs are ureotelic and eliminate nitrogen mainly as urea."
  },
  {
    "id": "Z32",
    "section": "Zoology",
  ...
  },
  {
    "id": "Z34",
    "section": "Zoology",
    "topic": "Urinogenital System",
    "difficulty": "Moderate",
    "question": "In a male frog, the ureters also function as:",
    "options": [
      "oviducts",
    ...
    "answer": 3,
    "explanation": "Male ureters carry both urine and sperm and are therefore called urinogenital ducts."
  },
  {
    "id": "Z35",
    "section": "Zoology",
  ...
  },
  {
    ...
    "difficulty": "Easy",
    "question": "The frog's central nervous system consists of the:",
    "options": [
  ...
  },
  {
    ...
    "difficulty": "Easy",
    "question": "The testes of a male frog are attached near the kidneys by a fold called:",
    "options": [
      "mesovarium",
      "mesorchium",
      "mesentery",
    ...
    "answer": 1,
    "explanation": "Each yellowish ovoid testis is attached to the upper part of a kidney by the mesorchium."
  },
  {
    "id": "Z41",
    "section": "Zoology",
  ...
  },
  {
    ...
    "topic": "Reproduction",
    "difficulty": "Easy",
    "question": "Fertilisation in frogs is generally:",
    "options": [
      "internal in the uterus",
      "internal in the cloaca",
      "external in water",
      "absent because development is direct"
    ],
    "answer": 2,
    "explanation": "During spawning, eggs and sperm are released into water, where external fertilisation occurs."
  },
  {
    "id": "Z44",
    "section": "Zoology",
  ...
  },
  {
    "id": "Z45",
    "section": "Zoology",
    "topic": "Organ-System Integration",
    "difficulty": "Moderate",
    "question": "Match each structure with its function.<div class='data-table-wrap'><table class='data-table'><thead><tr><th>Structure</th><th>Function</th></tr></thead><tbody><tr><td>A. Nictitating membrane</td><td>1. Carries urine and sperm in male</td></tr><tr><td>B. Tympanum</td><td>2. Protects eye</td></tr><tr><td>C. Ureter</td><td>3. Receives sound vibration</td></tr><tr><td>D. Cloaca</td><td>4. Common terminal chamber</td></tr></tbody></table></div>Select the correct matching.",
    "options": [
      "A-2, B-3, C-1, D-4",
      "A-3, B-2, C-4, D-1",
      "A-2, B-4, C-3, D-1",
    ...
    "answer": 0,
    "explanation": "The nictitating membrane protects the eye, tympanum receives sound, male ureter is urinogenital, and cloaca is the common terminal chamber."
  }
];
