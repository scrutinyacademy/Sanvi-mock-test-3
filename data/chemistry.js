window.CHEMISTRY_QUESTIONS = [
  ...
  },
  {
    ...
    "difficulty": "Easy",
    "question": "Which system can exchange both matter and energy with its surroundings?",
    "options": [
      "Open system",
      "Closed system",
      "Isolated system",
  ...
  },
  {
    ...
    "difficulty": "Easy",
    "question": "According to the chemistry sign convention, heat absorbed by a system has:",
    "options": [
      "q > 0",
      "q < 0",
      "q = 0",
      "a sign determined only by volume"
    ],
    "answer": 0,
    "explanation": "Energy entering the system as heat is assigned a positive sign."
  },
  {
    "id": "C09",
    "section": "Chemistry",
  ...
  },
  {
    ...
    "topic": "First Law",
    "difficulty": "Moderate",
    "question": "A system absorbs 50 kJ of heat and does 20 kJ of work on the surroundings. Its change in internal energy is:",
    "options": [
      "−70 kJ",
      "−30 kJ",
      "+30 kJ",
    ...
    "answer": 2,
    "explanation": "q=+50 kJ and w=−20 kJ. Thus ΔU=q+w=+30 kJ."
  },
  {
    "id": "C12",
    "section": "Chemistry",
    ...
    "answer": 0,
    "explanation": "An adiabatic boundary does not permit heat transfer, so q=0; work and energy change may still occur."
  },
  {
    "id": "C13",
    "section": "Chemistry",
  ...
  },
  {
    ...
    "topic": "ΔH and ΔU",
    "difficulty": "Moderate",
    "question": "For N₂(g) + 3H₂(g) → 2NH₃(g) at temperature T, the relation between ΔH and ΔU is:",
    "options": [
      "ΔH = ΔU + 2RT",
      "ΔH = ΔU − 2RT",
      "ΔH = ΔU + 4RT",
  ...
  },
  {
    ...
    "topic": "Calorimetry",
    "difficulty": "Easy",
    "question": "A bomb calorimeter operates essentially at constant volume and directly determines:",
    "options": [
      "ΔU of combustion",
      "ΔH of combustion",
      "ΔG of combustion",
    ...
    "answer": 0,
    "explanation": "The rigid bomb has constant volume, so its measured heat corresponds to qᵥ=ΔU."
  },
  {
    "id": "C20",
    "section": "Chemistry",
  ...
  },
  {
    ...
    "topic": "Hess's Law",
    "difficulty": "Easy",
    "question": "Hess's law is valid primarily because enthalpy is a:",
    "options": [
      "path function",
      "state function",
      "vector quantity",
  ...
  },
  {
    "id": "C27",
    "section": "Chemistry",
    "topic": "Formation Enthalpy Calculation",
    "difficulty": "Moderate",
  ...
  },
  {
    ...
    "topic": "Bond Enthalpy",
    "difficulty": "Moderate",
    "question": "Given bond enthalpies H–H = 436, Cl–Cl = 243 and H–Cl = 431 kJ mol⁻¹, estimate ΔH for H₂(g)+Cl₂(g)→2HCl(g).",
    "options": [
      "−183 kJ mol⁻¹",
      "+183 kJ mol⁻¹",
      "−674 kJ mol⁻¹",
  ...
  },
  {
    ...
    "topic": "Spontaneity",
    "difficulty": "Easy",
    "question": "For a spontaneous process in an isolated system, the entropy change of the universe is:",
    "options": [
      "negative",
      "zero only",
      "positive",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Negative Gibbs energy change is the criterion for spontaneity at constant T and P."
  },
  {
    "id": "C38",
    "section": "Chemistry",
  ...
  },
  {
    ...
    "difficulty": "Moderate",
    "question": "A reaction has ΔH<0 and ΔS>0. It is expected to be spontaneous:",
    "options": [
      "at all temperatures",
    ...
    "answer": 0,
    "explanation": "ΔG=ΔH−TΔS remains negative for all positive temperatures when ΔH is negative and ΔS positive."
  },
  {
    "id": "C40",
    "section": "Chemistry",
    "topic": "Temperature Dependence",
    "difficulty": "Moderate",
    "question": "For a reaction, ΔH=+40 kJ mol⁻¹ and ΔS=+100 J mol⁻¹ K⁻¹, assumed temperature independent. Above what temperature does ΔG become negative?",
    "options": [
      "100 K",
      "200 K",
      "400 K",
    ...
    "answer": 2,
    "explanation": "Set ΔG=0: T=ΔH/ΔS=40000/100=400 K. Above 400 K, TΔS exceeds ΔH."
  },
  {
    "id": "C41",
    "section": "Chemistry",
  ...
  },
  {
    "id": "C42",
    "section": "Chemistry",
    "topic": "Gibbs Energy and Equilibrium",
    "difficulty": "Moderate",
  ...
  },
  {
    ...
    "difficulty": "Moderate",
    "question": "An ideal gas undergoes isothermal expansion. Its change in internal energy is:",
    "options": [
      "positive",
      "negative",
      "zero",
      "equal to expansion work"
    ],
    "answer": 2,
    "explanation": "Internal energy of an ideal gas depends only on temperature; in an isothermal process, ΔT=0 and ΔU=0."
  },
  {
    "id": "C44",
    "section": "Chemistry",
    "topic": "Reversible Work",
    "difficulty": "Moderate",
  ...
  },
  {
    "id": "C45",
    "section": "Chemistry",
    "topic": "Integrated Data Question",
    "difficulty": "Moderate",
